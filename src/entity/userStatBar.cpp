...
UserStatBar::UserStatBar(const sf::Vector2f& positionVector, const sf::Vector2f& scaleVector, 
 ...
 const bool currentUser) {
    ...
    m_rankingNumberText = initializeText(
        ...
        m_sprite->getGlobalBounds().getPosition() + sf::Vector2f(7*4, 4*4),
        20 * 4,
        sf::Color::White
    );

    m_userIcon = initializeUserIcon(
        m_sprite->getGlobalBounds().getPosition() + sf::Vector2f(24*4, 4*4),
        6 * 4,
    ...
    m_usernameText = initializeText(
        username,
        m_sprite->getGlobalBounds().getPosition() + sf::Vector2f(42*4, 4*4),
        20 * 4,
        sf::Color::White
    );
    ...
    m_statText = initializeText(
        ...
        m_sprite->getGlobalBounds().getPosition() + sf::Vector2f(150*4, 4*4),
        20 * 4,
        sf::Color::White
    );
    ...
    m_numberToDisplayText = initializeText(
        ...
        m_sprite->getGlobalBounds().getPosition() + sf::Vector2f(220*4, 1*4),
        30 * 4,
        m_iconColours[userIconColour]
    );
